...
class Game:
    def __init__(self, players, toolbar_frame=None, gameboard_frame=None, player_hand_frame=None):
        """
        ...
        self.display = toolbar_frame != None and gameboard_frame != None and player_hand_frame != None
    ...
    def play(self):
        ...
        for _ in range(gc.NB_TURNS):
            ...
            for player in self.players:
                ...
                if self.display:
                    display_player_hand(self.player_hand_frame, player)
                    card_value = choose_card(self.toolbar_frame, player)
                else:
                    print(player)
                    card_value = None 
